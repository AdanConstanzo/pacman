...
def createTeam(firstIndex, secondIndex, isRed, first = 'DefensiveReflexAgent', second = 'DummyAgent'):
	"""
...
class DummyAgent(CaptureAgent):
	...
	def getWeights(self, gameState, action):
		...
		"""
		return {'distanceToFood': 50, 'foodOnBoard': 1000, 'distanceFromBaseIfPacmanAndCarrying': -3, 'scoreIncrease': 1000}
